    ...
    return (
        <div className="flex flex-col">
            ...
            <div className={`flex my-1 ${isMine ? "justify-end" : "justify-start"}`}>
                <div className={` flex gap-2 items-center px-2 ${isMine ? "bg-fuchsia-800/80 rounded-tl-md animate-from-right-to-left" : "bg-neutral-700 rounded-tr-md animate-from-left-to-right"} rounded-b-md text-white`}>
