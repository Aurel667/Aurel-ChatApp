    ...
    return (
        <div className="flex flex-col">
            ...
            <div id={id} className={`flex items-center gap-2 my-1 ${isMine && "flex-row-reverse"} group`}>
                <div className={` flex flex-col max-w-2/3 md:max-w-1/2 p-1 ${isMine ? "bg-fuchsia-800/80 rounded-tl-md" : "bg-neutral-700 rounded-tr-md"} animate-fade-in rounded-b-md text-white`}>
                    ...
                    <div className="flex flex-col gap-1 pb-1 px-2">
                        <p className="text-white text-sm word-wrap"> {message?.text} </p>
